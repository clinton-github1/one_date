...
<div class="tell-othrs"><a href="tell-others.php" class="pg-links">Divulgue</a></div>
...
class Signatures{
    ...
    if($result->num_rows>0){
        ...
        echo "<table width=100%; border= 1><tr><th>Code</th><th>Nome</th><th>Email Address</th><th>Cidade</th><th>País</th></tr>";
