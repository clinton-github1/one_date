...
<div class="tell-othrs"><a href="tell-others.php" class="pg-links">Ενημερώστε και άλλους</a></div>
...
class Signatures{
    ...
    if($result->num_rows>0){
        ...
        echo "<table width=100%; border= 1><tr><th>Code</th><th>Όνομα</th><th>Email Address</th><th>Πόλη</th><th>Χώρα</th></tr>";
