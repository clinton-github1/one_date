...
<section class="petition2">
    ...
    <div class="petition-form">
        ...
        <form action="petition.php" method="post">
            ...
            <input type="checkbox" name="progress" value="Checked" required checked>Por favor marque esta casilla si desea que lo mantengamos informado del avance de esta petición<br><br>
<!--
