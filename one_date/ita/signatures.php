...
<div class="tell-othrs"><a href="tell-others.php" class="pg-links">Dillo ad Altri</a></div>
...
class Signatures{
    ...
    if($result->num_rows>0){
        ...
        echo "<table width=100%; border= 1><tr><th>Code</th><th>Nome</th><th>Email Address</th><th>Città</th><th>Paese</th></tr>";
