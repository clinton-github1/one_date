...
<section class="petition2">
    ...
    <div class="petition-form">
        ...
        <form action="petition.php" method="post">
            ...
            <input type="checkbox" name="progress" value="Checked" required checked> Kreuzt bitte nebenstehendes Feld an, wenn ihr wünscht über den Fortschritt der Petition informiert zu werden<br><br>
<!--
