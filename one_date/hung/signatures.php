...
<div class="tell-othrs"><a href="tell-others.php" class="pg-links">Add tovább</a></div>
...
class Signatures{
    ...
    if($result->num_rows>0){
        ...
        echo "<table width=100%; border= 1><tr><th>Code</th><th>Név</th><th>Email Address</th><th>Város/Helység</th><th>Ország</th></tr>";
