...
<div class="tell-othrs"><a href="tell-others.php" class="pg-links">Расскажите другим</a></div>
...
class Signatures{
    ...
    if($result->num_rows>0){
        ...
        echo "<table width=100%; border= 1><tr><th>Code</th><th>Имя</th><th>Email Address</th><th>Город</th><th>Страна</th></tr>";
